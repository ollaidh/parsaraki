import unittest
from search_parameters import create_search_parameters_object, SearchParameters
...
class TestRequestParser(unittest.TestCase):
    def test_create_request_ok(self):
        input_json = ('{"lat": 34.7,'
                      ...
                      '"onlineViewing": "no"'
                      '}')
        expected = SearchParameters(lat=34.7, lon=33.3, radius=5000,
        ...
        self.assertEqual(expected, create_search_parameters_object(input_json))

    def test_create_request_errors(self):
        with self.assertRaises(ValueError) as exc:
            r = SearchParameters(lat=12.22, lon=33.33)
